...
2. **Environment Variables**:
   ...
   - **KEYSTATIC_GITHUB_TOKEN**: GitHub Personal Access Token for private repository access.
...
- **Keystatic Auth**: Ensure `NEXT_PUBLIC_KEYSTATIC_MODE` is set correctly for your environment (local or github).
